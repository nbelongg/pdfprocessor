"""
Database operations (legacy compatibility layer).

This module maintains backward compatibility by re-exporting all functions
from the new modular utils.db package.

New code should import directly from utils.db submodules:
- from utils.db.products import create_product
- from utils.db.jobs import update_job_status
- from utils.db.documents import save_parsed_document
- from utils.db.sources import create_data_source
- from utils.db.scheduling import create_scheduled_job

Existing code continues to work:
- from utils.database import create_product  # Still works!
"""
